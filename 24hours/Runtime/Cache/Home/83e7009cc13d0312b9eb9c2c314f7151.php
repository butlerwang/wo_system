...
<div class="loginpanel">
    <div class="loginpanelinner">
        ...
        <form id="login" action="<?php echo (C("ROOT")); ?>Index/index.html" method="post" onsubmit=" return ajax_login();">
...
<div class="loginfooter">
    <p>&copy; 2015. <a href="http://www.sz24hours.com" target="_blank">www.sz24hours.com.</a> 24hours All Rights Reserved.</p>
</div>	
...
<script>
	function ajax_login(){
		...
		$.ajax({
			type:"get",
			url:root+"Index/actionindex.html?username="+u+"&password="+p,
