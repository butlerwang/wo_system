        ...
        <div class="leftmenu">        
            <ul class="nav nav-tabs nav-stacked">
                ...
                <li class="dropdown"><a href=""><span class="iconfa-user"></span> 关于客户</a>
                	<ul>
                    	<li><a href="<?php echo (C("ROOT_INDEX")); ?>client.html">添加客户</a></li>
                        <li><a href="<?php echo (C("ROOT_INDEX")); ?>client.html">管理客户</a></li>
                        <li><a href="<?php echo (C("ROOT_INDEX")); ?>client.html">客户类型</a></li>
                    </ul>
                </li>
                ...
                <div class="row-fluid">
                        <div>
                            <form action="editprofile.html" id='form01' class="editprofileform" method="post">
                                ...
                                <input type="hidden" name="succeed" value="<?php echo ($succeed); ?>">
